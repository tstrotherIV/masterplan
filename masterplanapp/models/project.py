...
class Project(models.Model):
    ...
    deleted = models.BooleanField(default=None, blank=True, null=True)
    priority = models.BooleanField(default=None, blank=True, null=True)
    confirmed = models.BooleanField(default=None, blank=True, null=True)
